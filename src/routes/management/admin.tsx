...
export const Route = createFileRoute("/management/admin")({
  head: () => ({ meta: [{ title: "Admin — CSSEBET Management" }] }),
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900 p-4 space-y-2">
        ...
        <Link to="/admin">
          <Button className="bg-purple-500 hover:bg-purple-600 text-slate-950">
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900 p-4 space-y-3">
        <h2 className="font-semibold flex items-center gap-2"><ScrollText className="h-4 w-4 text-purple-400" /> Support audit log</h2>
