...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "cssebets: private World Cup 2026 prediction pool for friends. Virtual stakes only, no real money." },
      { property: "og:title", content: "cssebets — Private World Cup Predictions" },
      { property: "og:description", content: "cssebets: private World Cup 2026 prediction pool for friends. Virtual stakes only, no real money." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "cssebets — Private World Cup Predictions" },
      { name: "twitter:description", content: "cssebets: private World Cup 2026 prediction pool for friends. Virtual stakes only, no real money." },
