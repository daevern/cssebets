...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A closed community points club. Stake community points on football, F1 and UFC, or play CSSE Originals arcade games — one wallet, live odds, auditable settlements." },
      { property: "og:title", content: "CSSEBets – Community Sports Markets & House Arcade" },
      { property: "og:description", content: "A closed community points club. Stake community points on football, F1 and UFC, or play CSSE Originals arcade games — one wallet, live odds, auditable settlements." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "CSSEBets" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "CSSEBets – Community Sports Markets & House Arcade" },
      { name: "twitter:description", content: "A closed community points club. Stake community points on football, F1 and UFC, or play CSSE Originals arcade games — one wallet, live odds, auditable settlements." },
          ...
          "@graph": [
            {
              ...
              description:
                "Closed community points club for sports markets and CSSE Originals arcade.",
