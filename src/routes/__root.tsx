...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CSSEBets — Prediction Markets for the FIFA World Cup" },
      { name: "description", content: "The prediction market for the FIFA World Cup 2026. Trade live markets on match outcomes, momentum and lineups — powered by community-driven odds." },
      { property: "og:title", content: "CSSEBets — Prediction Markets for the FIFA World Cup" },
      { property: "og:description", content: "The prediction market for the FIFA World Cup 2026. Trade live markets on match outcomes, momentum and lineups — powered by community-driven odds." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "CSSEBets" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "CSSEBets — Prediction Markets for the FIFA World Cup" },
      { name: "twitter:description", content: "The prediction market for the FIFA World Cup 2026. Trade live markets on match outcomes, momentum and lineups." },
