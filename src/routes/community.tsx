...
export const Route = createFileRoute("/community")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet the CSSEBets community — players, leagues, and referrals." },
      { property: "og:title", content: "The CSSEBets community" },
      { property: "og:description", content: "Meet the CSSEBets community — players, leagues, and referrals." },
    ],
  }),
